                ...
                <div class="dialog">
                    <table>
                        <tbody>
                            ...
                            <tr class="prop">
                                <td valign="top" class="name">
                                  <label for="url"><g:message code="district.url.label" default="URL" /></label>
                                </td>
                                <td valign="top" class="value ${hasErrors(bean: districtInstance, field: 'url', 'errors')}">
                                    <g:textField name="url" value="${districtInstance?.url}" />
                                </td>
                            </tr>
